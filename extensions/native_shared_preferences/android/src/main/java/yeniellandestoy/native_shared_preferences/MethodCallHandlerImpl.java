...
class MethodCallHandlerImpl implements MethodChannel.MethodCallHandler {
    ...
    MethodCallHandlerImpl(Context context) {
        ...
        executor = new ThreadPoolExecutor(0, 1, 30L, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>());
            ...
            switch (call.method) {
                ...
                case "setInt":
                    ...
                    if (number instanceof BigInteger) {
                        ...
                        commitAsync(preferences.edit().putString(key, BIG_INTEGER_PREFIX + integerValue.toString(Character.MAX_RADIX)), result);
                    } else {
    ...
    private Map<String, Object> parsePreferences(Map<String, ?> allPrefs) throws IOException {
        ...
        for (String key : allPrefs.keySet()) {
            ...
            if (value instanceof String) {
                ...
                boolean success = preferences.edit().remove(key).putString(key, LIST_IDENTIFIER + encodeList(listValue)).commit();
                if (!success) {
